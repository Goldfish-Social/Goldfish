...
<template>
    <AppLayout title="User Profile">
        ...
        <section v-if="profile.followers !== null" class="dark:bg-gray-900 bg-gray-100 text-gray-900 dark:text-white">
                        ...
                        <tr v-for="follower in profile.followers" :key="follower.id">
                            <td>
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div class="mp-2">
                                        <InertiaLink :href="follower.userlink">
                                            <div class="font-bold hover:text-gray-300 dark:text-gray-900">
                                                {{ follower.name }}
                                            </div>
                                            <div class="text-sm opacity-50 hover:text-gray-300 dark:text-gray-900">
                                                @{{ follower.username }}
                                            </div>
                                        </InertiaLink>
                                    </div>
                            ...
                            <th class="flex justify-end">
                                ...
                                <InertiaLink
                                    ...
                                    class="btn btn-secondary gap-2" :href="route('follow', { id: follower.username })">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round">
                                        <path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
