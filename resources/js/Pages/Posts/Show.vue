...
<template>
    <AppLayout title="Post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-actions flex justify-between">
                                ...
                                <div class="flex justify-end">
                                     <InertiaLink class="btn btn-sm btn-secondary gap-2 mr-2" :href="route('show-post', { id: post.id })">
        ...
        <section>
         ...
         <section>
            <div
            v-if="post.replies !== null"
             class="py-2 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
